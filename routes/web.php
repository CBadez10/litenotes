...
// Resource model comes with all http requets methods 
...
// Prefix the trashed route to get rid of redundant code (not a resource model so need to define all http methods needed)
